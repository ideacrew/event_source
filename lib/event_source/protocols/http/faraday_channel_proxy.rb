  ...
  module Protocols
    module Http
      ...
      class FaradayChannelProxy
        ...
        def initialize(_faraday_connection_proxy, async_api_channel_item)
          @subject = build_faraday_channel_for(async_api_channel_item) unless async_api_channel_item.empty?
        end
